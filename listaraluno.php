...
// Ordenação
$sqlBase .= " ORDER BY nome LIMIT ? OFFSET ?";
            ...
            <div class="form-section bg-white border border-gray-200">
                ...
                <thead>
                    <tr class="bg-gray-200 text-gray-700" align="left">
                        ...
                        <th class="py-2 px-4">turma</th>
                        <th class="py-2 px-4">Data de Cadastro</th>
						<td></td>
						<h1> <th class="py-2 px-4">Ações</th></h1>
                       <td></td>
                    </tr>
                </thead>
                <tbody>
                    <?php if (count($alunos) > 0): ?>
                        <?php foreach ($alunos as $aluno): ?>
                            <tr class="border-t hover:bg-gray-50">
                                ...
                                <td class="py-2 px-4"><?= htmlspecialchars($aluno['nome']) ?></td>
                                <td class="py-2 px-4"><?= htmlspecialchars($aluno['serie']) ?></td>
                                <td class="py-2 px-4"><?= htmlspecialchars($aluno['turma']) ?></td>
                                <td class="py-2 px-4"><?= htmlspecialchars($aluno['data_cadastro']) ?></td> 
							    <td class="py-2 px-4"><a href="editaraluno.php?id=<?= $aluno['id'] ?>" class="px-6 py-2 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition-colors">Editar </a></td>
                                <td class="py-2 px-4"><a href="excluiraluno.php?id=<?= $aluno['id'] ?>" onclick="return confirm('Tem certeza que deseja excluir este Cadastro?')" class="px-6 py-2 bg-red-600 text-white font-semibold rounded-md hover:bg-red-700 transition-colors">Excluir </a>
