...
<body>
 ...
 <form id="cadastroForm" action="inserirlivro.php" method="POST">
                ...
                <div class="form-grid">
                    <table style="width:50%" align="center" >
						<tr > 
							...
							<td> <label for="nome" class="block text-xs font-medium text-gray-700">Código</label>		</td>
							<td> <input required type="text" id="codigo" name="codigo" class="w-full border border-gray-300 rounded-md focus:outline-none">		</td>
						</tr>	
						...
						<tr >	<td> <label for="titulo" class="block text-xs font-medium text-gray-700">Título</label>	</td>
							<td> <input type="text" id="titulo" name="titulo" required class="w-full border border-gray-300 rounded-md focus:outline-none"> </td>
						</tr >
						<tr >	<td> <label for="autor" class="block text-xs font-medium text-gray-700">Autor</label>	</td>
							<td> <input type="text" id="autor" name="autor" required class="w-full border border-gray-300 rounded-md focus:outline-none"> </td>
						</tr >	
							<tr >	<td> <label for="editora" class="block text-xs font-medium text-gray-700">Editora</label>	</td>
							<td> <input type="text" id="editora" name="editora" required class="w-full border border-gray-300 rounded-md focus:outline-none"> </td>
						</tr >						
						<tr >		<td> <label for="data_cadastro" class="block text-xs font-medium text-gray-700">Data de Cadastro</label> </td>
				
								<td> <input type="date" id="data_cadastro" name="data_cadastro" required class="w-full border border-gray-300 rounded-md focus:outline-none" >		</td>
							</tr>	                    		
						</tr >				
