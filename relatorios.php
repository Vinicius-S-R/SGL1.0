...
<table style="width:40%">				 <div class="max-w-4xl mx-auto">
                ...
                <!-- Retirada -->
			<tr>	<a href="registro.php" >      <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer group">
			 ...
			 <!-- Livros -->
              <a href="listarlivro.php" >   <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer group">
                    <div class="p-8 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Livros</h3>
                        <p class="text-gray-600 text-sm">Catálogo </p> </a>
                    </div>
                </div>

                <!-- Alunos -->
            <a href="listaraluno.php" >    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer group">
                    <div class="p-8 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Alunos</h3>
                        <p class="text-gray-600 text-sm">lista de Alunos</p></a>
                    </div>
                </div>		
                </div>
</table>				
